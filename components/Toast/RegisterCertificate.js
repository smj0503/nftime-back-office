                ...
                <div className={ styles.message }>
                    {
                        state ? (
                            <>
                                <span className={ styles.state }>{ t("toast.registerCertificate.success") }</span>
                                <span className={ styles.confirm }>{ t("toast.registerCertificate.successMessage") }</span>
                            </>
                        ) : (
                            <>
                                <span className={ styles.state }>{ t("toast.registerCertificate.failed") }</span>
                                <span className={ styles.confirm }>{ t("toast.registerCertificate.failMessage") }</span>
                            </>
                        )
                    }
                </div>
